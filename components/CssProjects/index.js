...
import { Card, CardBody, Row, Col, Button, CardImg, CardSubtitle, CardText, CardTitle } from 'reactstrap'
import Image from 'next/image';
// import image from '../../public/assets/1.jpeg'
function Index() {
    return (
        <div>
            <Row>
                        ...
                        <CardBody>
                            <div class="card__collection clear-fix">
                                <div class="cards cards--two">
                                    ...
                                    <p><Button className='project_exploreBtn'>Click Here</Button></p>                                    
                                </div>
                            </div>
                        </CardBody>
                    </Card>
